...
var states : Array[int] = [
	...
	0b01000001000000000000000000000000000000001000000000, # Norgans
	...
	0b01010001000000000000000000000000000100000000000000, # Idea depends on Deer?
	0b00010001000000000000000000000000001001000000000000, # Bohdi
